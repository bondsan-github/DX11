		...
		public:
			...
			class KeyboardStateTracker
			{
				public:
					...
					bool  is_key_pressed( Keys key ) const { return pressed.is_key_down( key ); }
					bool  is_key_released( Keys key ) const { return released.is_key_down( key ); }
			...
			void key_down( int key , Keyboard::State & state );
			void key_up( int key , Keyboard::State & state );
